...
To store data that an individual user would like to have preserved across page loads.

1. What does bcrypt do to help us store passwords in a secure manner.

It derives an encryption key from the password that the user sets, by generating a random 'salt', and returning a hashed version of the password.

1. What does bcrypt do to slow down attackers?

It slows hackers down by using the hashing algorithm, which creates slowness and multiple rounds, which make it exponentially more difficult for attackers to crack.
